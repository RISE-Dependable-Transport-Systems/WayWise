...
A fully-featured implementation for controlling WayWise-based vehicles (MAVLINK communication) can be found at [ControlTower](https://github.com/das-rise/ControlTower).
