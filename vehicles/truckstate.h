...
public:
    ...
    uint16_t getTrailerAngle() const { return mTrailerAngle; }
    void setTrailerAngle(uint16_t value) { mTrailerAngle = value; }
...
private:
    uint16_t mTrailerAngle; // Extra state for angle sensor
};
