...
MavsdkVehicleServer::MavsdkVehicleServer(QSharedPointer<VehicleState> vehicleState, QHostAddress controlTowerAddress, unsigned controlTowerPort, const QAbstractSocket::SocketType controlTowerSocketType) :
